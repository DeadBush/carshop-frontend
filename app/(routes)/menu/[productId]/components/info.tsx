...
const Info = ({product}: InfoProps) => {
    ...
    <div>
        ...
        <div className="mt-3 flex items-end justify-between">
            <p className="text-base text-left text-neutral-600">Product&apos;s details</p>
        </div>
        ...
        <div className="w-full grid grid-cols-4 my-12">
            <div className="col-span-1 space-y-8">
                ...
                <p className="text-lg font-semibold text-neutral-700">Amount</p>
            </div>
        ...
        <Button onClick={()=>addToCart(product)} className="w-full py-6 text-xl font-semibold hover:bg-hero hover:text-white flex items-center justify-center gap-3">Add to cart <ShoppingCart className="w-4 h-4"/></Button>
    </div>
    );
}
